...
INSERT INTO "new_CaseFile" ("createdAt", "debriefClosing", "debriefOverview", "debriefWhatHappened", "debriefWhyItWorked", "difficulty", "duration", "id", "isActive", "maxStage", "players", "slug", "solutionEvidence", "solutionMotive", "solutionSuspect", "summary", "title") SELECT "createdAt", "debriefClosing", "debriefOverview", "debriefWhatHappened", "debriefWhyItWorked", "difficulty", "duration", "id", "isActive", "maxStage", "players", "slug", "solutionEvidence", "solutionMotive", "solutionSuspect", "summary", "title" FROM "CaseFile";
DROP TABLE "CaseFile";
