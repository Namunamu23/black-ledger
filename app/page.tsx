          ...
          <div className="lg:pl-6">
            <div className="rounded-[2rem] border border-zinc-800 bg-zinc-900 p-5 shadow-2xl shadow-black/30">
              <div className="rounded-[1.5rem] border border-zinc-800 bg-zinc-950 p-6">
                ...
                >
                  View Case 001 <ArrowRight className="h-4 w-4" />
                </Link>
              </div>
            </div>
          </div>
            ...
            <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
              <div>
                <h3 className="text-2xl font-semibold text-white">
                  A grounded first case with real investigative texture
                </h3>
                <p className="mt-4 max-w-2xl text-base leading-8 text-zinc-300">
                  The Alder Street Review is built to establish the Black Ledger brand: a suspicious death, a weak official explanation, and an evidence trail that rewards careful review rather than random guesswork.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="mt-4 space-y-3 text-sm leading-7 text-zinc-300">
                  <li>Case summary and original incident report</li>
                  <li>Witness statements, records, and crime scene materials</li>
                  <li>Timeline and contradiction-based evidence review</li>
                  <li>Digital bureau access with guided review tools</li>
                </ul>

                <Link
                  href={featuredCase.href}
                  className="mt-6 inline-flex items-center rounded-2xl bg-white px-5 py-3 font-semibold text-zinc-950 transition hover:bg-zinc-200"
                >
                  Explore the Case
                </Link>
              </div>
